...
public class MainTest {
  ...
  @FixMethodOrder(MethodSorters.NAME_ASCENDING)
  public static class Task1_extended extends CliTest {

    public Task1_extended() {
      super(Main.class);
    }
  ...
  public static class YourTests extends CliTest {
    ...
    @Test
    public void T4_02_next_available_date() throws Exception {
      runCommands(
          unpack(
              CREATE_TEN_VENUES, //
              SET_DATE,
              ...
              options("GGG", "03/02/2024", "client001@email.com", "230"),
              MAKE_BOOKING,
              options("GGG", "05/02/2024", "clientemail002@email.com", "230"),
              PRINT_VENUES));
